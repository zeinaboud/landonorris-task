...
const HeroMouseContext =
  createContext<HeroMouseContextValue | null>(
    null,
  );

export const HeroMouseProvider = ({
  children,
}: {
  children: ReactNode;
}) => {
...
export const useHeroMouse = () => {
  ...
  if (!context) {
    throw new Error(
      "useHeroMouse must be used inside HeroMouseProvider",
    );
  }
